...
const updateComuna = () => {
    console.log("=== FUNCIÓN updateComuna EJECUTADA ===");
    ...
    console.log("Valor seleccionado:", regionSelect.value);
    console.log("region_comuna:", region_comuna);
    
    let selectedRegion = parseInt(regionSelect.value) - 1;                //Obtenemos el id de la region
    console.log("selectedRegion (número):", selectedRegion);

    comunaSelect.innerHTML = "";

    console.log("Intentando con índice:", region_comuna.regiones[selectedRegion - 1]);
    console.log("Intentando con find:", region_comuna.regiones.find(r => r.numero === selectedRegion));
    
    if (region_comuna.regiones[selectedRegion]) {
      console.log("Región encontrada!");
      region_comuna.regiones[selectedRegion].comunas.forEach(comuna => {
        console.log("Agregando comuna:", comuna.nombre);
